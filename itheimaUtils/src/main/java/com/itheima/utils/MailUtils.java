...
public class MailUtils {
    ...
    public static final String SMTP_HOST_ADDRESS = "smtp.sina.com";
    // 发件人邮箱的用户名.例如 username
    public static final String USERNAME = "13047900833";
    // 发件人邮箱的密码.例如 password
    public static final String PASSWORD = "llf123456789";
    // 发件人邮箱地址.例如 zhangsan@qq.com
    public static final String SENDER = "13047900833@sina.cn";
